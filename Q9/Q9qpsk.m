function y=Q9qpsk(ebno) 
 ...
 distance=zeros(1,4);
 for i=1:nsymbols 
    distance(1)=reciever_out(i)-(1+1i); 
    distance(2)=reciever_out(i)-(-1+1i);
    distance(3)=reciever_out(i)-(-1-1i);
    distance(4)=reciever_out(i)-(1-1i); 
